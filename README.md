...
**Keep it short and simple!** Seleccionaremos el proyecto que sea simple, elegante y al grano `(por ejemplo: un minijuego en 100 líneas de código hecho en JS)`. La optimización e ingenio son la clave para ganar esta categoría. Lo importante en esta categoría es **usar solo una tecnología**, es decir, solo Python o solo Javascript. Solo puedes elegir un lenguaje de programación para realizar este desafío.  

---

## Mr. Robot Award

Seleccionaremos la aplicación que implemente la mayor cantidad de funcionalidades. Demuéstrales a los reclutadores que sabes crear o consumir API's, implementar dependencias, bibliotecas de terceros, uso correcto de herencia e interfaces y más!
